...
一款 Android 离线汉字字典应用，支持笔画顺序动画、语音查字、拼音检索、词语听写、成语词典、游戏化学习等功能。

## 当前版本

**V2.0** - AI智能推荐、游戏化学习、社交功能、专业词库
...
- **成语词典**：常用成语（100条），支持分类查询
- **语音识别听写**：语音输入替代手动输入
- **学习进度统计**：学习时长、正确率、连续学习天数

### V2.0 新增功能
- **AI智能推荐**：基于遗忘曲线算法，智能推荐复习内容
- **游戏化学习**：成语接龙、词语填空、成语猜谜三种游戏模式
- **社交功能**：排行榜、成就系统，激励用户学习
- **专业词库**：医学专业术语（90条），支持分类浏览
